...
export const poblar_BaseDatos = async (req, res) => {
    ...
    try {
        ...
        const {
            ...
            email_empresa,
            estado_contratista,
            nombre_contratista_propio,
            apellido_paterno_contratista,
            apellido_materno_contratista,
        ...
        const newContratista = await Contratista.create({
            ...
            estado: estado_contratista,
            nombre: nombre_contratista_propio,
            apellido_paterno: apellido_paterno_contratista,
            apellido_materno: apellido_materno_contratista,
