...
def predictTemperatura(nombreCuartel):
    # Cargar datos
    file_path_P = f'../modelos/temperatura.csv'
    ...
    ph = data_P['temperatura'].to_numpy()
    ...
    model_N.load_state_dict(torch.load('../modelos/modelo_temperatura.pth', map_location=torch.device('cpu')))
    model_N.eval()
