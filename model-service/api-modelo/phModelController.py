...
def predictPH(nombreCuartel):
    # Cargar datos
    file_path_P = f'../modelos/ph.csv'
    ...
    model_N.load_state_dict(torch.load('../modelos/modelo_ph.pth', map_location=torch.device('cpu')))
    model_N.eval()
